...
CXXFLAGS=-O1 -g -funwind-tables -Werror -std=gnu++14 -mabi=purecap -fno-exceptions -fno-rtti  -msoft-float

all: gctest.dump slab_test.dump
...
${INSTALL_DIR}/slab_test: slab_test.cc slab_allocator.hh config.hh page.hh cheri.hh
	${SDK}/bin/clang ${CXXFLAGS} slab_test.cc  -lpthread -o ${INSTALL_DIR}/slab_test -static -mabi=purecap -lc
